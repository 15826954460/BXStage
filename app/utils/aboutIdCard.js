...
const IdCardUtils = {
   ...
   */
  jsGetAge: (idCardNum) => {
    let strBirthday = String(idCardNum).slice(6,14)
    let returnAge;
    let birthYear = strBirthday.slice(0, 4);
    let birthMonth = strBirthday.slice(4, 6);
    let birthDay = strBirthday.slice(6);
